...
function custom_afterhours_2014() { 
	
	register_post_type( 'afterhours_2014', 
	 	
		array('labels' => array(
			'name' => __('2014 After Hours', 'bonestheme'), /* This is the Title of the Group */
			...
			'description' => __( '2014 Decibel Festival After Hours', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'db2014/afterhours', 'with_front' => false ), /* you can specify its url slug */
	...
	register_taxonomy_for_object_type('post_tag', 'afterhours_2014');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'custom_afterhours_2014');

	add_filter( 'cmb_meta_boxes', 'afterhours_2014_info' );
	function afterhours_2014_info( $meta_boxes ) {

		$prefix = '_afterhours_2014_'; // Prefix for all fields

		$meta_boxes[] = array(
			'id' => 'afterhours_2014_metabox',
			'title' => 'After Hours Details',
			'pages' => array('afterhours_2014'), // post type
			'context' => 'normal',
			'priority' => 'high',
