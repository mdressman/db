...
function custom_boatparty_2015() { 
	
	register_post_type( 'boatparty_2015', 
	 	
		array('labels' => array(
			'name' => __('2015 Boat Parties', 'bonestheme'), /* This is the Title of the Group */
			...
			'description' => __( '2015 Decibel Festival Boat Party', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'db2015/boatparty', 'with_front' => false ), /* you can specify its url slug */
	...
	register_taxonomy_for_object_type('post_tag', 'boatparty_2015');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'custom_boatparty_2015');

	add_filter( 'cmb_meta_boxes', 'boatparty_2015_info' );
	function boatparty_2015_info( $meta_boxes ) {

		$prefix = '_boatparty_2015_'; // Prefix for all fields

		$meta_boxes[] = array(
			'id' => 'boatparty_2015_metabox',
			'title' => 'Boat Party Details',
			'pages' => array('boatparty_2015'), // post type
			'context' => 'normal',
			'priority' => 'high',
