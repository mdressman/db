...
function custom_optical_2014() { 
	
	register_post_type( 'optical_2014', 
	 	
		array('labels' => array(
			'name' => __('2014 Optical', 'bonestheme'), /* This is the Title of the Group */
			...
			'description' => __( '2014 Decibel Festival Optical', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'db2014/optical', 'with_front' => false ), /* you can specify its url slug */
	...
	register_taxonomy_for_object_type('post_tag', 'optical_2014');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'custom_optical_2014');

	add_filter( 'cmb_meta_boxes', 'optical_2014_info' );
	function optical_2014_info( $meta_boxes ) {

		$prefix = '_optical_2014_'; // Prefix for all fields

		$meta_boxes[] = array(
			'id' => 'optical_2014_metabox',
			'title' => 'Optical Details',
			'pages' => array('optical_2014'), // post type
			'context' => 'normal',
			'priority' => 'high',
