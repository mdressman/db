...
function custom_artist_2015() { 
	// creating (registering) the custom type 
	register_post_type( 'artist_2015', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('2015 Artists', 'bonestheme'), /* This is the Title of the Group */
			'singular_name' => __('Artist', 'bonestheme'), /* This is the individual type */
			'all_items' => __('All 2015 Artists', 'bonestheme'), /* the all items menu item */
			...
			'description' => __( 'Performing artist at Decibel Festival', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
	...
	add_action( 'init', 'custom_artist_2015');
    
add_filter( 'cmb_meta_boxes', 'promoter_artist_info_2015' );
function promoter_artist_info_2015( $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'pages' => array('artist_2015'), // post type
		'context' => 'normal',
		'priority' => 'high',
...
add_action( 'init', 'be_initialize_cmb_meta_boxes_2015', 9999 );
function be_initialize_cmb_meta_boxes_2015() {
