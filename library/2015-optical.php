...
function custom_optical_2015() { 
	
	register_post_type( 'optical_2015', 
	 	
		array('labels' => array(
			'name' => __('2015 Optical', 'bonestheme'), /* This is the Title of the Group */
			...
			'description' => __( '2015 Decibel Festival Optical', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'db2015/optical', 'with_front' => false ), /* you can specify its url slug */
	...
	register_taxonomy_for_object_type('post_tag', 'optical_2015');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'custom_optical_2015');

	add_filter( 'cmb_meta_boxes', 'optical_2015_info' );
	function optical_2015_info( $meta_boxes ) {

		$prefix = '_optical_2015_'; // Prefix for all fields

		$meta_boxes[] = array(
			'id' => 'optical_2015_metabox',
			'title' => 'Optical Details',
			'pages' => array('optical_2015'), // post type
			'context' => 'normal',
			'priority' => 'high',
