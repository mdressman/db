		...
		<div class="row">
			<div class="span6">
			    ...
			    <?php 
					...
					$showcase_2014_fields = array('_showcase_2014_date', '_showcase_2014_tickets_link','_showcase_2014_facebook_link','_showcase_2014_crateplayer_link','_showcase_2014_soldout');

					$showcase_2014_data = array();

					foreach($showcase_2014_fields as $showcase_2014_field) {
						$showcase_2014_data[$showcase_2014_field] = get_post_meta($post->ID, $showcase_2014_field, true);
					}
				...
				?>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<?php 
							...
							switch($showcase_2014_data['_showcase_2014_date']) {
								case "wednesday":
						...
						<?php if($showcase_2014_data['_showcase_2014_date']) { ?>
				...
				<div class="row">
					<div class="span3">
						...
						$connected_artists = new WP_Query( 
												array(
													'connected_type' => 'artists_to_showcases_2014',
						...
						$connected_venue = new WP_Query( 
												array(
													'connected_type' => 'showcase_2014_to_venue',
													'connected_items' => get_queried_object(),
													'nopaging' => true,
												) 
											);
					...
					<div class="span3">
						...
						<div class="row">
							<div class="span3">
								...
								if($showcase_2014_data['_showcase_2014_crateplayer_link']) {
									echo do_shortcode('[soundcloud]' . $showcase_2014_data['_showcase_2014_crateplayer_link'] . '[/soundcloud]');
								}
								?>
							</div>
						</div>

						<?php if($showcase_2014_data['_showcase_2014_tickets_link']) { ?>
						<div class="row">
							<div class="span3">
								<?php if($showcase_2014_data['_showcase_2014_soldout']) { ?>
								...
								<?php } else { ?>
									<a class="sidebar-button" href="<?php echo $showcase_2014_data['_showcase_2014_tickets_link'] ?>" target="_blank"><h1>BUY TICKETS</h1></a>
								<?php } ?>
							</div>
						</div>
						<?php } ?>

						<?php if($showcase_2014_data['_showcase_2014_facebook_link']) { ?>
						<div class="row">
							<div class="span3">
								<a class="sidebar-button" href="<?php echo $showcase_2014_data['_showcase_2014_facebook_link'] ?>" target="_blank"><h1>FACEBOOK RSVP</h1></a>
							</div>
						</div>
						<?php } ?>
