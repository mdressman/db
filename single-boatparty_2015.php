		...
		<div class="row">
			<div class="span6">
			    ...
			    <?php 
					...
					$boatparty_2015_fields = array('_boatparty_2015_date', '_boatparty_2015_tickets_link','_boatparty_2015_facebook_link','_boatparty_2015_crateplayer_link','_boatparty_2015_soldout');

					$boatparty_2015_data = array();

					foreach($boatparty_2015_fields as $boatparty_2015_field) {
						$boatparty_2015_data[$boatparty_2015_field] = get_post_meta ($post->ID, $boatparty_2015_field, true);
					}
				...
				?>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<?php 
							...
							switch($boatparty_2015_data['_boatparty_2015_date']) {
								case "wednesday":
						...
						<?php if($boatparty_2015_data['_boatparty_2015_date']) { ?>
				...
				<div class="row">
					<div class="span3">
						...
						$connected_artists = new WP_Query( 
												array(
													'connected_type' => 'artists_to_boatparty_2015',
						...
						$connected_venue = new WP_Query( 
												array(
													'connected_type' => 'boatparty_2015_to_venue',
													'connected_items' => get_queried_object(),
													'nopaging' => true,
												) 
											);
					...
					<div class="span3">
						...
						<div class="row">
							<div class="span3">
								...
								if($boatparty_2015_data['_boatparty_2015_crateplayer_link']) {
									echo do_shortcode('[soundcloud]' . $boatparty_2015_data['_boatparty_2015_crateplayer_link'] . '[/soundcloud]');
								}
								?>
							</div>
						</div>

						<?php if($boatparty_2015_data['_boatparty_2015_tickets_link']) { ?>
						<div class="row">
							<div class="span3">
								<?php if($boatparty_2015_data['_boatparty_2015_soldout']) { ?>
								...
								<?php } else { ?>
									<a class="sidebar-button" href="<?php echo $boatparty_2015_data['_boatparty_2015_tickets_link'] ?>" target="_blank"><h1>BUY TICKETS</h1></a>
								<?php } ?>		
							</div>
						</div>
						<?php } ?>

						<?php if($boatparty_2015_data['_boatparty_2015_facebook_link']) { ?>
						<div class="row">
							<div class="span3">
								<a class="sidebar-button" href="<?php echo $boatparty_2015_data['_boatparty_2015_facebook_link'] ?>" target="_blank"><h1>FACEBOOK RSVP</h1></a>
							</div>
						</div>
						<?php } ?>
